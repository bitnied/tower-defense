#!/usr/bin/env python3
"""Gera assets placeholder para Elisa's Defence."""
import math, os
...
# ---------- 5. Background do mapa (U deitado) ----------
W, H = 1152, 648
img = Image.new("RGB", (W, H), "#F7E1EA")
d = ImageDraw.Draw(img)
# textura sutil: bolinhas
import random
...
# caminho em U deitado (mesmos pontos do Path2D, world+576/324)
path_pts = [(1176, 134), (246, 134), (146, 234), (146, 414), (246, 514), (1116, 514)]
...
dashed(path_pts)
# seta de entrada
d.polygon([(1130, 110), (1130, 158), (1090, 134)], fill="#D96A94")
d.text((1108, 92), "ENTRADA", font=font(15), fill="#B04A74", anchor="mm")
# zona da mamãe
d.ellipse([1116-58, 514-58, 1116+58, 514+58], outline="#FF9DBB", width=5)
...
draw_heart(d, 60, 90, 60, "#FF4D7E", outline="#FFF6FA", ow=4)
draw_heart(d, 843, 90, 60, "#FF4D7E", outline="#FFF6FA", ow=4)
d.text((450, 168), "PLACEHOLDER — substituir por lettering final", font=font(18),
